        ...
        extends GenericHibernateDAO<Patient, Long>
{
    ...
    public List<Patient> findByQuery(String query)
    {
        ...
        for (String string : parts)
        {
            ...
            else if(insuranceNumber == null && PatientValidator.isInsuranceNumber(string, true))
            {
	...
	public List<Patient> findByData(String forename, String lastname, String insuranceNumber)
	{
	    ...
	    Example ex = Example.create(template1).enableLike(MatchMode.ANYWHERE).excludeZeroes().ignoreCase();
	    Example ex2 = Example.create(template2).enableLike(MatchMode.ANYWHERE).excludeZeroes().ignoreCase();
