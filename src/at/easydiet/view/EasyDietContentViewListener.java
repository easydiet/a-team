...
public interface EasyDietContentViewListener {
    ...
    public static class Adapter implements EasyDietContentViewListener {
        public void navigationButtonInserted(EasyDietContentView contentView, int index) {
        }
        
        public void navigationButtonsRemoved(EasyDietContentView contentView, int index,
            Sequence<NavigationButton> navigationButtons) {
        }
    ...
    /**
     * Called when a navigationButton has been inserted into a EasyDietContentView.
     * @param contentView
     * @param index
     */
    public void navigationButtonInserted(EasyDietContentView contentView, int index);
     ...
     */
    public void toolbarButtonsRemoved(EasyDietContentView contentView, int index,
