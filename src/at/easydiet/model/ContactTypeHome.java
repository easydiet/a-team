 ...
 * @see at.easydiet.model.ContactType
...
public class ContactTypeHome {
    ...
    public ContactType merge(ContactType detachedInstance) {
        ...
        try {
            ContactType result = (ContactType) sessionFactory.getCurrentSession()
    ...
    public ContactType findById( java.lang.String id) {
        ...
        try {
            ContactType instance = (ContactType) sessionFactory.getCurrentSession()
                    .get("at.easydiet.model.ContactType", id);
            if (instance==null) {
    ...
    public List<ContactType> findByExample(ContactType instance) {
        ...
        try {
            List<ContactType> results = (List<ContactType>) sessionFactory.getCurrentSession()
                    .createCriteria("at.easydiet.model.ContactType")
                    .add( create(instance) )
            .list();
