...
/**
 * Home object for domain model class Recipe.
 * @see at.easydiet.model.Recipe
 * @author Hibernate Tools
 */
public class RecipeHome {

    private static final Log log = LogFactory.getLog(RecipeHome.class);
    ...
    public void persist(Recipe transientInstance) {
        log.debug("persisting Recipe instance");
        try {
    ...
    public Recipe merge(Recipe detachedInstance) {
        ...
        try {
            Recipe result = (Recipe) sessionFactory.getCurrentSession()
    ...
    public Recipe findById( long id) {
        ...
        try {
            Recipe instance = (Recipe) sessionFactory.getCurrentSession()
                    .get("at.easydiet.model.Recipe", id);
            if (instance==null) {
    ...
    public List<Recipe> findByExample(Recipe instance) {
        log.debug("finding Recipe instance by example");
        try {
            List<Recipe> results = (List<Recipe>) sessionFactory.getCurrentSession()
                    .createCriteria("at.easydiet.model.Recipe")
                    .add( create(instance) )
            .list();
