 ...
 * @see at.easydiet.model.SystemUser
 * @author Hibernate Tools
 */
public class SystemUserHome {

    private static final Log log = LogFactory.getLog(SystemUserHome.class);
    ...
    public void persist(SystemUser transientInstance) {
        log.debug("persisting SystemUser instance");
        try {
    ...
    public SystemUser merge(SystemUser detachedInstance) {
        ...
        try {
            SystemUser result = (SystemUser) sessionFactory.getCurrentSession()
    ...
    public SystemUser findById( long id) {
        ...
        try {
            SystemUser instance = (SystemUser) sessionFactory.getCurrentSession()
                    .get("at.easydiet.model.SystemUser", id);
            if (instance==null) {
    ...
    public List<SystemUser> findByExample(SystemUser instance) {
        ...
        try {
            List<SystemUser> results = (List<SystemUser>) sessionFactory.getCurrentSession()
                    .createCriteria("at.easydiet.model.SystemUser")
                    .add( create(instance) )
            .list();
