...
public class GenderHome {
    ...
    public Gender merge(Gender detachedInstance) {
        ...
        try {
            Gender result = (Gender) sessionFactory.getCurrentSession()
    ...
    public Gender findById( java.lang.String id) {
        ...
        try {
            Gender instance = (Gender) sessionFactory.getCurrentSession()
                    .get("at.easydiet.model.Gender", id);
            if (instance==null) {
    ...
    public List<Gender> findByExample(Gender instance) {
        log.debug("finding Gender instance by example");
        try {
            List<Gender> results = (List<Gender>) sessionFactory.getCurrentSession()
                    .createCriteria("at.easydiet.model.Gender")
                    .add( create(instance) )
            .list();
