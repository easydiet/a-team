...
public class PatientBO {
	 ...
	 * 
	 * @param gender
	 *            the Gender to reference in this Patient.
	 */
...
/**
	...
	/**
	 * Adds a new Recipe to the list of referenced disfavors. The cache will
	 * updated
	 * 
	 * @param disfavors
	 *            the Recipe to add.
	...
	/**
	 * Removes the given Recipe from the list of referenced disfavors. The cache
	 * will updated
	 * 
	 * @param disfavors
	 *            the timespan to add.
