...
public class DietParameterTemplateBO
{
     ...
     * 
     * @return the CheckOperator currently referenced in this
    ...
    public CheckOperatorBO getCheckOperator()
    {
        ...
        {
            _checkOperator = CheckOperatorBO.getForModel(_model
                    .getCheckOperator());
        }
     ...
     * 
     * @param checkOperator
     *            the CheckOperator to reference in this DietParameterTemplate.
     */
    ...
    public ParameterDefinitionUnitBO getParameterDefinitionUnit()
    {
        ...
        {
            _parameterDefinitionUnit = new ParameterDefinitionUnitBO(
                    _model.getParameterDefinitionUnit());
        }
     ...
     *            the ParameterDefinitionUnit to reference in this
     *            DietParameterTemplate.
     */
    public void setParameterDefinitionUnit(
            ParameterDefinitionUnitBO parameterDefinitionUnit)
    {
     ...
     * 
     * @return the DietParameterType currently referenced in this
     *         DietParameterTemplate.
     */
    public DietParameterTypeBO getDietParameterType()
    {
        ...
        {
            _dietParameterType = DietParameterTypeBO.getForModel(_model
                    .getDietParameterType());
        }
     ...
     *            the DietParameterType to reference in this
     *            DietParameterTemplate.
     */
     ...
     * 
     * @return the ParameterDefinition currently referenced in this
     *         DietParameterTemplate.
     */
    public ParameterDefinitionBO getParameterDefinition()
    {
        ...
        {
            _parameterDefinition = new ParameterDefinitionBO(
                    _model.getParameterDefinition());
        }
     ...
     *            the ParameterDefinition to reference in this
     *            DietParameterTemplate.
     */
     ...
     * 
     * @return the DietParameterSet currently referenced in this
     *         DietParameterTemplate.
     */
    public DietParameterSetBO getDietParameterSet()
    {
        if (_dietParameterSet == null && _model.getDietParameterSet() != null)
        {
            _dietParameterSet = new DietParameterSetBO(
                    _model.getDietParameterSet());
        }
     ...
     *            the DietParameterSet to reference in this
     *            DietParameterTemplate.
     */
    public void setDietParameterSet(
            DietParameterSetBO dietParameterSet)
    {
